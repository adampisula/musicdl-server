...
CREATE TABLE
    Artists (id SERIAL PRIMARY KEY, name TEXT NOT NULL UNIQUE);
...
ALTER TABLE Files ADD CONSTRAINT Files_track_id_fk_Tracks_id FOREIGN KEY (track_id_fk) REFERENCES Tracks (id);
